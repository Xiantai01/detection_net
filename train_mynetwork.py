...
from defect_dataset import DEFDataSet
...
def main():
    ...
    random.seed(0)
    list_train = random.sample(range(1, 301), 295)
    data_root = "./NEU-DEF"  # VOCdevkit
    aspect_ratio_group_factor = 3
    batch_size = 8
    amp = True  # 混合精度训练
    list_validation = random.sample(range(1,301),5)

    train_dataset = DEFDataSet(data_root, list_train, data_transform["train"])
    train_sampler = None
    ...
    val_dataset = DEFDataSet(data_root, list_validation, data_transform["val"])
