...
def ResNet101(num_classes=128):
    return ResNet(Bottleneck, [3,4,23,3], num_classes)

def ResNet18_backbone(num_classes=128):
    return ResNet(BasicBlock, [2,2,2,2], num_classes, include_top=False)

def ResNet50_backbone(num_classes=128):
    return ResNet(Bottleneck, [3,4,6,3], num_classes, include_top=False)
